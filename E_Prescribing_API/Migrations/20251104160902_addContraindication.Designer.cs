...
namespace E_Prescribing_API.Migrations
{
    ...
    [Migration("20251104160902_addContraindication")]
    partial class addContraindication
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("E_Prescribing_API.Models.ContraIndication", b =>
                {
                    ...
                    b.Property<int>("ConditionDiagnosisConditionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ConditionDiagnosisConditionId");
            ...
            modelBuilder.Entity("E_Prescribing_API.Models.ContraIndication", b =>
                {
                    ...
                    b.HasOne("E_Prescribing_API.Models.ConditionDiagnosis", "ConditionDiagnosis")
                        .WithMany()
                        .HasForeignKey("ConditionDiagnosisConditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
